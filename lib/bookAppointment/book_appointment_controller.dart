...
// bring data from the database using AppointementModel
        AppointementModel appointementModel =
            AppointementModel.fromJson(jsonDecode(response.body));
        selectedEvents = {};
        // store events in selectedEvents Map
        for (Datum item in appointementModel.data) {
          if (selectedEvents.isNotEmpty) {
            // if appointment date is not available in the map it will return null
