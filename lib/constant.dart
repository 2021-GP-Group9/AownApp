...
class constant {
  ...
  static String get_donation_status="https://awoon.000webhostapp.com/get_donation_status.php";
  static String comment = "https://awoon.000webhostapp.com/comment.php";
