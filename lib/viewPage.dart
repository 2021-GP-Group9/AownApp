  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      Row(
          children: <Widget>[
            Expanded(child: Text(
                charityModel.city, textAlign: TextAlign.right,
      ...
      Row(
          children: <Widget>[
            Expanded(child: Text(
                charityModel.location, textAlign: TextAlign.right,
                textDirection: TextDirection.rtl,
                style: TextStyle(
                  fontFamily: 'Almarai Light',
                  fontSize: 14,)),
      ...
      Row(
          children: <Widget>[
            Expanded(child: Text(
                charityModel.phone, textAlign: TextAlign.right,
                textDirection: TextDirection.rtl,
                style: TextStyle(
                  fontFamily: 'Almarai Light',
                  fontSize: 14,)),
            ...
            Expanded(child: Text("رقم الهاتف:", textAlign: TextAlign.right,
                ...
                children: <Widget>[
                  Expanded(child: Text(
                      charityModel.licenseNumber,textAlign:
      ...
      Row(
          ...
          children: <Widget>[
            Expanded(child: Text(
                charityModel.email, textAlign: TextAlign.right,
                textDirection: TextDirection.rtl,
                style: TextStyle(
                  fontFamily: 'Almarai Light',
                  fontSize: 14,)),
      ...
      Row(
          children: <Widget>[
            Expanded(child: Text(
                charityModel.donationType, textAlign: TextAlign.right,
                textDirection: TextDirection.rtl,
                style: TextStyle(
                  fontFamily: 'Almarai Light',
                  fontSize: 14,)),
      ...
      Row(
          children: <Widget>[
            Expanded(child: Text(
                charityModel.service, textAlign: TextAlign.right,
                textDirection: TextDirection.rtl,
                style: TextStyle(
                  fontFamily: 'Almarai Light',
                  fontSize: 14,)),
